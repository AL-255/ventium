...
| 4 | Iterative divider (P5 occupancy, EDX:EAX coupling, `#DE`) | **SPEC'd-deferred** | `docs/m5-div-spec.md` (occupancy 17/25/41 DIV, 22/30/46 IDIV; `#DE` div-by-0/overflow — NOTE current code raises NO `#DE`) |
