...
#
# Run:  vivado -mode batch -source fpga/scripts/impl_route_fppipe.tcl -notrace
# =====================================================================
set ROOT [pwd]
...
set OUT  $ROOT/fpga/build/[expr {$PBLOCK ? "route_fppipe_pblock" : "route_fppipe"}]
file mkdir $OUT
set PART xck26-sfvc784-2LV-c
create_project -in_memory -part $PART probe_route_fppipe
