...
#
# Run:  vivado -mode batch -source fpga/scripts/synth_paths_fppipe.tcl -notrace
# =====================================================================
set ROOT [pwd]
...
set RTL  $ROOT/rtl
set OUT  $ROOT/fpga/build/paths_fppipe
file mkdir $OUT
set PART xck26-sfvc784-2LV-c
create_project -in_memory -part $PART probe_paths_fppipe
